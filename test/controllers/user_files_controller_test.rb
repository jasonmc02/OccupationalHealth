...
class UserFilesControllerTest < ActionController::TestCase
  ...
  test "should create user_file" do
    assert_difference('UserFile.count') do
      post :create, user_file: { file: @user_file.file, name: @user_file.name, note: @user_file.note, share: @user_file.share, user_id: @user_file.user_id }
    end
  ...
  test "should update user_file" do
    patch :update, id: @user_file, user_file: { file: @user_file.file, name: @user_file.name, note: @user_file.note, share: @user_file.share, user_id: @user_file.user_id }
    assert_redirected_to user_file_path(assigns(:user_file))
  end
