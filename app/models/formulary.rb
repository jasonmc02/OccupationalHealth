class Formulary < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :formulary_profile, :allow_destroy => true
  accepts_nested_attributes_for :formulary_context, :allow_destroy => true
  accepts_nested_attributes_for :formulary_research, :allow_destroy => true
  accepts_nested_attributes_for :formulary_action, :allow_destroy => true
  accepts_nested_attributes_for :formulary_policy, :allow_destroy => true
  accepts_nested_attributes_for :formulary_contacts, :allow_destroy => true
